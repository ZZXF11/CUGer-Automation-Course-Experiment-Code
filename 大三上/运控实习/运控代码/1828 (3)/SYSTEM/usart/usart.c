...
double temp_data ;
	if(USART_GetITStatus(USART1,USART_IT_RXNE) != RESET)
	{
		...
		t++;
		if(t ==1 && data[0] != 0xB1 && data[0] != 0xB2 && data[0] != 0xB3 && 
			data[0] != 0xB4 && data[0] != 0xB5&& data[0] != 0xB6&& data[0] != 0xB7
		&& data[0] != 0xB8&& data[0] != 0xB9 && data[0] != 0xA1 && data[0] != 0xA2 
		&& data[0] != 0xA3&& data[0] != 0xA4 && data[0] != 0xA5&& data[0] != 0xA6
		&& data[0] != 0xA7&& data[0] != 0xC3 && data[0] != 0xC4 && data[0] != 0xC5 
		&& data[0] != 0xC6 && data[0] != 0xD4&& data[0] != 0xD5&& data[0] != 0xf4  )	
			{     //第 0 号数据不是帧头，跳过
			t = 0;
	    }
