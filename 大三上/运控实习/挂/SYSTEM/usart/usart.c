...
double temp_data ;
	if(USART_GetITStatus(USART1,USART_IT_RXNE) != RESET)
	{
		...
		t++;
		if(t ==1 && data[0] != 0xB1 && data[0] != 0xB2 && data[0] != 0xB3 && data[0] != 0xA1 && data[0] != 0xA2 && data[0] != 0xC3 && data[0] != 0xC4 && data[0] != 0xC5 && data[0] != 0xC6&& data[0] != 0xD3 && data[0] != 0xD4 && data[0] != 0xD5 && data[0] != 0xD6 )	
			{     //第 0 号数据不是帧头，跳过
			t = 0;
	    }
		...
		if(t == 3 && data[0] == 0xA1 ){//straightx,y
		 mark = 2;
		straight_x = data[1];
	  straight_y = data[2];
		}
