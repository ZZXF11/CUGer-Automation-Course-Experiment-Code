...
#define GPF2_EINT (2<<(4*2))

#define GPF0_int (0x2<<(0*2))
#define GPF1_int (0x2<<(0*2))
#define GPF2_int (0x2<<(0*2))
#define GPF4_int (0x2<<(0*2))
...
void init_led()
{
	GPBCON = GPB5_out | GPB6_out | GPB7_out | GPB8_out;		//设置I/O口GPB5,GPB6,GPB7为输出属性
